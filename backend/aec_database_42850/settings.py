"""
Django settings for aec_database_42850 project.
...
ROOT_URLCONF = 'aec_database_42850.urls'
...
WSGI_APPLICATION = 'aec_database_42850.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aec_database_42850 API",
    "DESCRIPTION": "API documentation for aec_database_42850 App",
    "VERSION": "v1",
}
